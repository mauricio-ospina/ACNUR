...
{
    public partial class OperationsModuleCollectionView : XtraUserControl
    {
        public OperationsModuleCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<WinAdministrator.ViewModels.OperationsModuleCollectionViewModel>();
            ...
            fluentAPI.SetBinding(GrcOperationsModule, gControl => gControl.DataSource, x => x.Entities);
            ...
            ((DevExpress.XtraBars.Docking2010.WindowsUIButton)windowsUIButtonPanel.Buttons[5]).Click += (s, e) => { GrcOperationsModule.ShowRibbonPrintPreview(); };
        }
    }
}
