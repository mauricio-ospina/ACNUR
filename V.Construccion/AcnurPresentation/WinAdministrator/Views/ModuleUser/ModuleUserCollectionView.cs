...
{
    public partial class ModuleUserCollectionView : XtraUserControl
    {
        public ModuleUserCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<WinAdministrator.ViewModels.ModuleUserCollectionViewModel>();
            ...
            fluentAPI.SetBinding(GrcModuleUser, gControl => gControl.DataSource, x => x.Entities);
            ...
            ((DevExpress.XtraBars.Docking2010.WindowsUIButton)windowsUIButtonPanel.Buttons[5]).Click += (s, e) => { GrcModuleUser.ShowRibbonPrintPreview(); };
        }
    }
}
