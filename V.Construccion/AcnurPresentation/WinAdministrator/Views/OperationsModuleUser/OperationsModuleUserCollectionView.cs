...
{
    public partial class OperationsModuleUserCollectionView : XtraUserControl
    {
        public OperationsModuleUserCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<WinAdministrator.ViewModels.OperationsModuleUserCollectionViewModel>();
