...
{
    public partial class ModulesCollectionView : XtraUserControl
    {
        public ModulesCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<WinAdministrator.ViewModels.ModulesCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as Acnur.App.Repository.Data.Modules,
