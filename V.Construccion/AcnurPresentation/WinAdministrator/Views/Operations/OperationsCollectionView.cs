...
{
    public partial class OperationsCollectionView : XtraUserControl
    {
        public OperationsCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<WinAdministrator.ViewModels.OperationsCollectionViewModel>();
            ...
            fluentAPI.SetBinding(GrcOperations, gControl => gControl.DataSource, x => x.Entities);
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as Acnur.App.Repository.Data.Operations,
            ...
            ((DevExpress.XtraBars.Docking2010.WindowsUIButton)windowsUIButtonPanel.Buttons[5]).Click += (s, e) => { GrcOperations.ShowRibbonPrintPreview(); };
        }
    }
}
