...
namespace WinAdministrator.Views.ComponentsByModuleCollectionView
{
    public partial class ComponentsByModuleCollectionView : XtraUserControl
    {
        public ComponentsByModuleCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<WinAdministrator.ViewModels.ComponentsByModuleCollectionViewModel>();
            ...
            fluentAPI.SetBinding(GrcComponentsByModule, gControl => gControl.DataSource, x => x.Entities);
            ...
            ((DevExpress.XtraBars.Docking2010.WindowsUIButton)windowsUIButtonPanel.Buttons[5]).Click += (s, e) => { GrcComponentsByModule.ShowRibbonPrintPreview(); };
        }
    }
}
