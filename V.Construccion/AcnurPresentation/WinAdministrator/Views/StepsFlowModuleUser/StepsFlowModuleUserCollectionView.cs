...
{
    public partial class StepsFlowModuleUserCollectionView : XtraUserControl
    {
        public StepsFlowModuleUserCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<WinAdministrator.ViewModels.StepsFlowModuleUserCollectionViewModel>();
