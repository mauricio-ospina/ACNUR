...
namespace WinAdministrator.Views.ParameterDetailCollectionView
{
    public partial class ParameterDetailCollectionView : XtraUserControl
    {
        public ParameterDetailCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<WinAdministrator.ViewModels.ParameterDetailCollectionViewModel>();
