...
// ***********************************************************************
// <copyright file="FacadeUsers.cs" company="Alto Comisionado de las Naciones Unidas para los Refugiados - ACNUR">
...
namespace Acnur.App.Implementation
{
    ...
    /// Class FacadeUsers.
    /// </summary>
    public class FacadeUsers : FacadeGeneric<Users>, IFacadeUsers
    {
    }
}
