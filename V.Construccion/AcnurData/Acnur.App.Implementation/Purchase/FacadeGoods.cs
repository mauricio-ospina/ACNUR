...
// ***********************************************************************
// <copyright file="FacadeGoods.cs" company="Alto Comisionado de las Naciones Unidas para los Refugiados - ACNUR">
...
namespace Acnur.App.Implementation
{
    ...
    /// Class FacadeGoods.
    /// </summary>
    public class FacadeGoods : FacadeGeneric<Goods>, IFacadeGoods
    {
    }
}
