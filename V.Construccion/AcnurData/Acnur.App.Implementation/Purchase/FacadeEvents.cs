...
// ***********************************************************************
// <copyright file="FacadeEvents.cs" company="Alto Comisionado de las Naciones Unidas para los Refugiados - ACNUR">
...
namespace Acnur.App.Implementation
{
    ...
    /// Class FacadeEvents.
    /// </summary>
    public class FacadeEvents : FacadeGeneric<Events>, IFacadeEvents
    {
    }
}
