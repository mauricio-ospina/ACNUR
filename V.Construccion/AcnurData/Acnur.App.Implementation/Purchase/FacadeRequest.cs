...
// ***********************************************************************
// <copyright file="FacadeRequest.cs" company="Alto Comisionado de las Naciones Unidas para los Refugiados - ACNUR">
...
namespace Acnur.App.Implementation
{
    ...
    /// Class FacadeRequest.
    /// </summary>
    public class FacadeRequest : FacadeGeneric<Request>, IFacadeRequest
    {
    }
}
