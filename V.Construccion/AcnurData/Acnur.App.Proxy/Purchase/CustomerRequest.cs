...
// ***********************************************************************
// <copyright file="CustomerRequest.cs" company="Alto Comisionado de las Naciones Unidas para los Refugiados - ACNUR">
...
namespace Acnur.App.Proxy
{
    ...
    /// </summary>
    public class CustomerRequest : CustomerGenericFacade<IFacadeRequest, Request>, IFacadeRequest
    {
    }
}
