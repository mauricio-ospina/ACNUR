...
// ***********************************************************************
// <copyright file="CustomerEvents.cs" company="Alto Comisionado de las Naciones Unidas para los Refugiados - ACNUR">
...
namespace Acnur.App.Proxy
{
    ...
    /// </summary>
    public class CustomerEvents : CustomerGenericFacade<IFacadeEvents, Events>, IFacadeEvents
    {
    }
}
