...
// ***********************************************************************
// <copyright file="CustomerGoods.cs" company="Alto Comisionado de las Naciones Unidas para los Refugiados - ACNUR">
...
namespace Acnur.App.Proxy
{
    ...
    /// Class CustomerGoods.
    /// </summary>
    public class CustomerGoods : CustomerGenericFacade<IFacadeGoods, Goods>, IFacadeGoods
    {
    }
}
