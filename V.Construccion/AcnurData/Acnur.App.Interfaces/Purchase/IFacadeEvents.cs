...
// ***********************************************************************
// <copyright file="IFacadeEvents.cs" company="Alto Comisionado de las Naciones Unidas para los Refugiados - ACNUR">
...
namespace Acnur.App.Interfaces
{
    ...
    /// <summary>
    /// Interface IFacadeEvents
    /// </summary>
    [ServiceContract]
    public interface IFacadeEvents : IFacadeGeneric<Events>
    {
    }
}
